...
public class TriangleTest {
    ...
    public void constructorTest(){
        Assert.assertThrows("Неверное значение первой стороны!", IllegalArgumentException.class,
                ()-> new Triangle(-4,5,6));
        Assert.assertThrows("Неверное значение второй стороны!", IllegalArgumentException.class,
                ()-> new Triangle(4,0,6));
        Assert.assertThrows("Неверное значение третьей стороны!", IllegalArgumentException.class,
